        ...
        <div className="relative text-black dark:text-white">
            ...
            >
                <ul className="flex flex-col gap-5 py-5 border-b border-stroke px-7">
                    ...
                    {/* <li
                        className="flex items-center justify-between cursor-pointer gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
                        onClick={() => {
                            setDropdownOpen(false);
                            toggleDemoMode();
                        }}
                        title={isDemoMode
                            ? "Switch to Live Mode - Show your real Plaid account data"
                            : "Switch to Demo Mode - Show sample data for demonstration"
                        }
                    >
                        <div className="flex items-center gap-3.5">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-xs text-gray-500">
                                    {isDemoMode ? 'Sample data' : 'Real accounts'}
                                </span>
                            </div>
                        </div>
                ...
                <div className="border-t border-stroke">
                    <button
                        className="flex items-center gap-3.5 px-7 py-3 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base w-full text-left"
                        onClick={() => {
                            // Clear demo mode preference and sign out to force user recreation
                            localStorage.removeItem('demoModePreference')
                            signOut()
                        }}
                        title="Sign out and clear preferences to reset your account"
                    >
                        <svg
                            className="fill-current"
                            width="18"
                        ...
                        >
                            <path
                                d="M9 0C4.037 0 0 4.037 0 9s4.037 9 9 9 9-4.037 9-9S13.963 0 9 0zm0 16c-3.859 0-7-3.141-7-7s3.141-7 7-7 7 3.141 7 7-3.141 7-7 7z"
                                fill="currentColor"
                            />
                            <path
                                d="M12.5 8H6.914l1.793-1.793c.391-.391.391-1.023 0-1.414s-1.023-.391-1.414 0L4.086 8l3.207 3.207c.391.391 1.023.391 1.414 0s.391-1.023 0-1.414L6.914 10H12.5c.553 0 1-.447 1-1s-.447-1-1-1z"
                                fill="currentColor"
                            />
                        </svg>
                        Reset & Sign Out
